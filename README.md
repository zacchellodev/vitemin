...
Vite is already fast, but 🍊 Vitemin 🍊 is more simple and cool 😎
...
Vitemin was created to developers who dream about a more easy way to start a vite + react project.

```shell
git clone https://github.com/zacchellodev/vitemin.git
```
### For each OS
